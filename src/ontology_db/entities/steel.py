...
class Steel(Base):
    ...
    entity_class_id = Column(Integer, ForeignKey(''))
    ...
    alloying_elements = relationship('Alloying_element', secondary=steels_alloying_elements_association, backref='steels')
